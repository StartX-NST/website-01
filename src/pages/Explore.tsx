...
const communities = [
	{
		...
		description:
			'Software engineers and tech enthusiasts building the future',
		members: 450,
		icon: Code2,
	},
	{
	...
	},
	{
		...
		name: 'Robotics Lab',
		description:
			'Hardware enthusiasts working on robotics and IoT projects',
		members: 180,
		icon: Bot,
	},
	{
		...
		description:
			'Entrepreneurs focused on strategy, operations, and growth',
		members: 290,
		icon: TrendingUp,
	},
];
			...
			<motion.div
				...
				<div className='mb-16'>
					...
					<p className='text-xl text-muted-foreground/90 max-w-2xl leading-relaxed'>
						Discover opportunities, communities, and showcase your
						work
					</p>
				</div>
