          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
            ...
            <FadeIn>
              <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-[1.05] tracking-tight mb-8">
                <span className="text-white">Build startups that</span>
                <br />
        ...
        <section className="relative py-16 md:py-24 lg:py-32 px-6 overflow-hidden z-10">
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <div className="text-center mb-12 md:mb-16 lg:mb-20">
              ...
              <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto">
                Join a community where action beats theory, and every student
                founder gets the support they need to succeed.
              </p>
            </div>
                    ...
                    <div className="mb-8">
                      <div className="bg-gradient-to-br from-gray-900/60 to-black/80 backdrop-blur-sm border border-gray-800/50 rounded-xl p-6 hover:border-blue-500/30 transition-all duration-300">
                        ...
                        <p className="text-sm text-gray-400 leading-relaxed">
                          Start with clarity. We help you refine your idea, test
                          its uniqueness, and validate real market need.
                        </p>
                      </div>
                    </div>
                  ),
                    ...
                    <div className="mb-8">
                      <div className="bg-gradient-to-br from-gray-900/60 to-black/80 backdrop-blur-sm border border-gray-800/50 rounded-xl p-6 hover:border-blue-500/30 transition-all duration-300">
                        ...
                        <p className="text-sm text-gray-400 leading-relaxed mb-4">
                          Deep dive into user research. Learn to conduct
                          interviews, analyze behavior patterns, and understand
                  ...
                  content: (
                    <div className="mb-8">
                      <div className="bg-gradient-to-br from-gray-900/60 to-black/80 backdrop-blur-sm border border-gray-800/50 rounded-xl p-6 hover:border-blue-500/30 transition-all duration-300">
                        ...
                        <p className="text-sm text-gray-400 leading-relaxed">
                          Design a winning strategy. From pricing models to
                          go-to-market plans, we help you create a roadmap that
                          actually works.
                        </p>
                      </div>
                    </div>
                  ...
                  content: (
                    <div className="mb-8">
                      <div className="bg-gradient-to-br from-gray-900/60 to-black/80 backdrop-blur-sm border border-gray-800/50 rounded-xl p-6 hover:border-blue-500/30 transition-all duration-300">
                        ...
                        <p className="text-sm text-gray-400 leading-relaxed mb-4">
                          Build your MVP in weeks, not months. Get hands-on with
                          rapid prototyping, testing, and iterating based on
                          real user feedback.
                        </p>
                        <div className="bg-gradient-to-br from-blue-500/5 to-transparent border border-blue-500/10 rounded-lg p-4">
                          ...
                          <p className="text-gray-400 text-xs">
                            Intensive development with mentor check-ins
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  content: (
                    <div className="mb-8">
                      <div className="bg-gradient-to-br from-gray-900/60 to-black/80 backdrop-blur-sm border border-gray-800/50 rounded-xl p-6 hover:border-blue-500/30 transition-all duration-300">
                        ...
                        <p className="text-sm text-gray-400 leading-relaxed">
                          Perfect your pitch, launch to real users, and start
                          scaling. Get ready for demo days, investor meetings,
                          and growth.
                        </p>
                      </div>
                    </div>
              ...
              <div className="relative border border-gray-800 rounded-3xl bg-gradient-to-b from-black/60 to-black/40 backdrop-blur-sm p-8 md:p-12 lg:p-20 overflow-hidden">
                <div className="relative text-center">
                  ...
                  <p className="text-lg md:text-xl text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                    Join hundreds of student founders building the next
                    generation of startups. No equity. No fees. Just builders
                    helping builders.
                  </p>
