	...
	const contactInfo = [
		{
			...
			text: 'hello@startx.community',
			href: 'mailto:hello@startx.community',
		},
		{
			icon: (
				<MapPin
	...
	const socialLinks = [
		{
			...
			label: 'Twitter',
			href: 'https://twitter.com/startx',
		},
		{
			icon: <Instagram size={20} />,
			label: 'Instagram',
			href: 'https://instagram.com/startx',
		},
		{
			icon: <Linkedin size={20} />,
			label: 'LinkedIn',
			href: 'https://linkedin.com/company/startx',
		},
		{
			icon: <Github size={20} />,
			label: 'Github',
			href: 'https://github.com/startx',
		},
	];
