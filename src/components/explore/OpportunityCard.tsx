...
const typeConfig = {
	internship: { label: 'Internship', color: 'emerald' },
	challenge: { label: 'Challenge', color: 'emerald' },
	hackathon: { label: 'Hackathon', color: 'emerald' },
	accelerator: { label: 'Accelerator', color: 'emerald' },
};
