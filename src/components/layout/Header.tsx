    ...
    <>
      <header
        ...
        className={`fixed top-0 left-0 right-0 z-50 px-6 md:px-12 py-6 transition-all duration-300 ${
          scrolled
            ? "bg-black/80 backdrop-blur-md border-b border-white/5 py-4 shadow-[0_8px_30px_rgb(0,0,0,0.5)]"
            : "bg-transparent"
        }`}
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          {/* Navigation Links - Desktop Minimal Design */}
          ...
          <div className="flex items-center gap-2 md:gap-3">
            {!isAuthenticated ? (
              <>
                ...
                >
                  <span className="bg-white text-black px-6 py-2.5 rounded-full text-sm font-semibold transition-colors group-hover:bg-white/95">
                    Sign In
                  </span>
              ...
              <>
                ...
                {user?.role === "user" &&
                  (user.applicationStatus === "none" ||
                    ...
                    >
                      <span className="bg-blue-500 text-black px-6 py-2.5 rounded-full text-sm font-semibold transition-colors group-hover:bg-blue-400">
                        Apply for Membership
                      </span>
                      <span className="w-10 h-10 rounded-full bg-blue-500 text-black flex items-center justify-center transition-transform group-hover:translate-x-1">
                        <ArrowRight className="w-4 h-4" />
                      </span>
                    </Link>
                  )}
